...
/** \brief Realiza todos los pasos para agregar una persona al archivo
 *
 * \return
 *
 */
void agregar ()
{
    ...
    {
        recuadroStr("Hubo un problema. No se agrego la persona.");
    }
 ...
 *
 * \param pelicula la lista de peliculas a ser agregadas en el archivo.
